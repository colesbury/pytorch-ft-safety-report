...
<details>
<summary>Fixed (4 issues)</summary>

| Severity | Component | Issue | PR |
|----------|-----------|-------|----|
| SEVERE | guards | [`dict_recursive_tag_watch_callback` calls `disable_recursive_dict_tag_optimization` without root lock](dict-recursive-tag-watch-callback-calls-disable-recursive-dict-tag-optimization-.md) | [#178703](https://github.com/pytorch/pytorch/pull/178703) |
